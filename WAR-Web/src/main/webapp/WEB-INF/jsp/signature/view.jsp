...
<c:choose>
  <c:when test="${not empty signature}">
    document.write('<div style="font-family:Arial,Helvetica,sans-serif;font-size:11px;width:500px;border-width:1px;border-color:#ccc;border-style:solid;">');
    document.write('<table>');
    document.write('<tr><td rowspan="2">');
    document.write('<a href="http://localhost:8080/WAR-Web/main/sign?username=${signature.endUser.username}">');
    ...
    document.write('<br>');
    document.write('<img src="http://localhost:8080/WAR-Web/main/signature/image?username=${signature.endUser.username}" height="50px" width="350px"/>');
    document.write('</td></tr>');
  ...
  <c:otherwise>
    ...
    document.write('If you are <i>${username}</i> and you are the owner, please <a href="http://localhost:8080/WAR-Web/main/sign?username=${username}">click here</a>');
    document.write('</td></tr>');
    document.write('</table>');
    document.write('</div>');
  </c:otherwise>
